...
void HolyBlessing::onUnlock(Character& owner) {
    owner.modifyStat("healing_bonus_percentage", std::make_unique<AddModifier>(0.05f));
    owner.modifyStat("healing_bonus_base", std::make_unique<AddModifier>(3.0f));
...
void MiracleWorker::onUnlock(Character& owner) {
    owner.modifyStat("healing_bonus_percentage", std::make_unique<AddModifier>(0.10f));
    owner.modifyStat("healing_bonus_base", std::make_unique<AddModifier>(5.0f));
